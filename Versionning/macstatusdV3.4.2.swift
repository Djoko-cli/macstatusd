...
// v3.4.2 — gestion wake + post-interaction + polling écran
...
// MARK: - v3.4.2 Wake + Idle Timeout + Polling
...
Timer.scheduledTimer(withTimeInterval: 0.1, repeats: true) { _ in
    ...
    // Unlock → annule wakePending + idle monitoring
    ...
    // v3.4.2 — activité HID sur loginwindow : écran allumé + verrouillé

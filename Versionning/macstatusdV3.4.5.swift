...
// v3.4.5 — wake + post-interaction + polling écran + resync display wake
...
// MARK: - v3.4.5 Wake + Idle Timeout + Polling
...
Timer.scheduledTimer(withTimeInterval: 0.1, repeats: true) { _ in
    ...
    // Wake visuel après pseudo-sleep : écran rallumé alors qu'on croit encore être asleep
